        ...
        <div class="form">
            ...
            <div class="files-table center" v-show="files.length">
                ...
                <label class="group center">
                    ...
                    <select class="select-input" v-model="combine_type">
...
export default {
    ...
    methods: {
        ...
        async send() {
            ...
            if (!this.combine_type) {
                return alert('Не выбран тип объединения');
            }
            ...
            formData.append('extension', this.combine_type)

            let response = null;

            try {
                response = await axios.post('/api/v1/combine/files', formData, {
        ...
        async getCombinedTypes() {
            ...
            this.available_types = response.data.types.combine
        }
    },
